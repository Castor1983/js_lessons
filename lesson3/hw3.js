...
let index1 = 0;
while (index1 < 20) {
    document.write(`<h1>Okten school is cool ${index1} </h1>`);
    index1++;
}
...
// task 6  Використовуючи данні з масиву, за допомоги document.write та циклу побудувати структуру по шаблону  Зробити адекватну стилізацію
...
// task 7 є масив. за допомоги циклу вивести:
console.log('7.1********************');
let users = [
